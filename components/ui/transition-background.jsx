  ...
  return (
    <div className="absolute inset-0">
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center ">
        <div className='text-8xl gluten-custom m-2 text-blue-500'>Welcome to EduToons</div>
        {!isSignedIn &&
          <>
        ...
        {!isSignedIn && isLoaded &&
          <div className="relative flex m-14 gap-24">
            <SignInButton className="w-32 h-14 text-xl  z-10 bg-blue-950 p-2 rounded-l-full hover:text-2xl transition-all      text-opacity-100 opacity-80        " mode="modal" />
            <div className=" absolute inset-0   flex items-center justify-center">
              <div className="bg-gradient-to-r from-blue-950 to-redish p-2 w-24 h-14          opacity-75 text-opacity-0  "></div>
            </div>
            <SignUpButton className="w-32 h-14 text-xl  z-10 bg-redish p-2 rounded-r-full hover:text-2xl transition-all        text-opacity-100 opacity-80 " mode="modal" redirectUrl="/role" />
          </div>
        }
